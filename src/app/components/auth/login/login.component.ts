  ...
  template: `
    <div class="auth-container" [class.lamp-on]="isLampOn()">
      ...
      <div class="content-section">
        ...
        <div class="info-grid">
          <div class="info-card">
            <h3><i class="fas fa-route"></i> Guide de Démarrage</h3>
            <p>Créez votre CV professionnel en quelques étapes simples :</p>
            <ul>
              <li>Choisissez un template adapté à votre profil</li>
              <li>Remplissez vos informations personnelles</li>
              <li>Ajoutez vos expériences et formations</li>
              <li>Personnalisez le style et téléchargez</li>
            </ul>
          </div>

          <div class="info-card">
            <h3><i class="fas fa-star"></i> Fonctionnalités Premium</h3>
            <p>Débloquez tout le potentiel de votre CV :</p>
            <ul>
          ...
          <div class="info-card">
            <h3><i class="fas fa-lightbulb"></i> Conseils Pro</h3>
            <p>Optimisez votre CV pour attirer les recruteurs :</p>
            <ul>
              <li>Mettez en avant vos réalisations</li>
              <li>Utilisez des mots-clés pertinents</li>
              <li>Gardez un design professionnel</li>
        ...
        <div class="encouragement-section">
          <h2>✨ Votre Carrière Mérite le Meilleur ✨</h2>
          <p>
            Rejoignez des milliers de professionnels qui ont transformé leur CV avec CaVenger.<br>
            Créez un CV qui vous représente et qui ouvre les portes de vos opportunités de carrière.
          </p>
        </div>
      ...
      <div class="container">
        <div class="lamp-container">
          ...
          <div class="lamp-hint" *ngIf="!isLampOn()">
            <i class="fas fa-hand-pointer"></i> Tirez sur la chaîne pour vous connecter
          </div>
        </div>
  ...
  onSubmit(): void {
    if (this.loginForm.valid) {
      ...
      this.authService.login(credentials).subscribe({
        next: (response) => {
          if (response.success) {
            // Récupérer l'URL de retour ou rediriger vers la page d'accueil
        ...
        error: (error) => {
          this.errorMessage.set(error || 'Erreur lors de la connexion. Veuillez réessayer.');
          this.isLoading.set(false);
        }
      });
    }
